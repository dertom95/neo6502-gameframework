...
/*block:function*/            
            case /*name:function_id*/0x01/*endname*/: {
                ...
                /*name:if|auto|if:@return_type!='void',@return_type call_result =,*//*endname*/  /*name:name*/do_somedata/*endname*/(/*block:parameter*/ /*name:type|if:@type.endswith("*"),(keyboard_mapping_t*)(&mem[,*//*endname*/ /*name:if|auto|if:@type=='uint16_t',swap16(,*//*endname*/call->/*name:name*/some_byte/*endname*//*name:if|auto|if:@type=='uint16_t',),*//*endname*/ /*name:type|if:@type.endswith("*"),]),*//*endname*/ /*name:some|auto|post_n_blast:comma*//*endname*/  /*endblock:parameter*/);
